...
#define BNO055_HEADING 0x1a
#define BNO055_ROLL 0x1c
#define BNO055_PITCH 0x1e
#define BNO055_QUAT_W 0x20
#define BNO055_QUAT_X 0x22
#define BNO055_QUAT_Y 0x24
#define BNO055_QUAT_Z 0x26
#define BNO055_LIA_X 0x28
#define BNO055_LIA_Y 0x2a
#define BNO055_LIA_Z 0x2c
#define BNO055_GRAV_X 0x2e
#define BNO055_GRAV_Y 0x30
#define BNO055_GRAV_Z 0x32
/* USER CODE END PD */
...
double BNO055_GET_DATA(uint8_t addr, uint16_t dataSize);
/* USER CODE END PFP */
...
int main(void)
{
  ...
  {
	  BNO055_INIT();
	  xAccel = BNO055_GET_DATA(BNO055_ACCEL_X, 2);
	  yAccel = BNO055_GET_DATA(BNO055_ACCEL_Y, 2);
	  zAccel = BNO055_GET_DATA(BNO055_ACCEL_Z, 2);
	  xMag = BNO055_GET_DATA(BNO055_MAG_X, 2);
	  yMag = BNO055_GET_DATA(BNO055_MAG_Y, 2);
	  zMag = BNO055_GET_DATA(BNO055_MAG_Z, 2);
	  xGyro = BNO055_GET_DATA(BNO055_GYRO_X, 2);
	  yGyro = BNO055_GET_DATA(BNO055_GYRO_Y, 2);
	  zGyro = BNO055_GET_DATA(BNO055_GYRO_Z, 2);
